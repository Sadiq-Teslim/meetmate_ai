  ...
  return (
    ...
    >
      ...
      <motion.button
        whileHover={{
          scale: 1.05,
          boxShadow: "0px 10px 20px -5px rgba(37, 99, 235, 0.4)",
        }}
        whileTap={{ scale: 0.95 }}
...
const PhoneMockup: React.FC = () => {
  return (
    <motion.div
      ...
      className="relative w-[300px] h-[600px] rounded-[40px] shadow-2xl"
    >
      ...
      {/* <div className="w-full h-full bg-slate-100 rounded-[32px] p-4 flex flex-col text-slate-900">
        ...
        <div className="bg-white rounded-lg shadow-sm p-3 mt-6 space-y-1">
          ...
          <p className="text-xs text-slate-500">
            16 Jan 2025 at 13:58 - 10 min, 40 sec
          </p>
        </div>
        <div className="flex-grow" />
        <motion.button
          whileHover={{ scale: 1.03 }}
          className="w-full bg-blue-600 text-white font-semibold py-3 rounded-full shadow-lg"
        >
          Start Taking Notes
        </motion.button>
      </div> */}
      ...
      >
        ...
        <main className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              The AI-powered app for effortless meeting minutes. Record,
              transcribe, and summarize meetings in seconds.
            </motion.p>
            <motion.div
              variants={{
                hidden: { opacity: 0, y: 20 },
